...
export const SERVICE_NAV_ITEMS: ServiceNavItem[] = [
  ...
  },
  {
    ...
    href: "/strike-that",
    description:
      "We provide MCA - Struck off companies services to help you comply with the MCA and improve your financial performance and decision-making.",
  },
  {
  ...
  },
  {
    title: "IPO Readiness",
    href: "/ipo-readiness",
    description: "We provide IPO readiness services to help you prepare for your IPO.",
  },
];
