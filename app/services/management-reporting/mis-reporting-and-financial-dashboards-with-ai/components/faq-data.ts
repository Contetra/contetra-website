...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      `Some common signs: management reports are consistently late, numbers don't match across reports, there's heavy dependence on one person's Excel sheet, profitability by product/customer/project is unclear, cash flow visibility is weak, or decisions are being made on gut feel rather than data. Any of these usually indicate it's time to revisit the reporting setup.`,
  },
  {
    question: `What does Contetra review before designing a dashboard for us?`,
    answer:
      `Business objectives, existing reports, ERP/accounting data structure, chart of accounts, cost centres, revenue streams, customer and product data, working capital metrics, and what management actually needs to make decisions. This groundwork ensures the dashboard reflects how the business really operates, not a generic template.`,
  },
  {
    question: `How long does it typically take to set up an MIS dashboard?`,
    answer:
      `Timelines vary depending on data readiness and complexity a business with clean, well-structured ERP data will move faster than one still relying on scattered spreadsheets. Contetra typically starts with a short diagnostic to assess data quality and reporting needs before giving a realistic timeline.`,
  },
  {
    question: `Is our financial data secure when Contetra sets up these dashboards?`,
    answer:
      `Yes. Financial and operational data is handled with strict confidentiality, and access is limited to what's needed for the engagement. This is a standard part of how Contetra works with any client's sensitive business data.`,
  },
  {
    question: `Does Contetra provide support after the dashboard is built?`,
    answer:
      `Yes. Dashboards need periodic review as business needs, data sources or reporting requirements evolve. Contetra can support ongoing maintenance, refinements and updates as required, rather than treating it as a one-time build.`,
  },
];
