...
const SLUG = "technical-accounting-advisory";

const page = accountingSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/accounting-reporting/technical-accounting-advisory";
...
export default function TechnicalAccountingAdvisoryPage() {
  return (
    <>
      <Hero
