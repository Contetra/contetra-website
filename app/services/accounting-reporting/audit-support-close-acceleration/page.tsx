...
const SLUG = "audit-support-close-acceleration";

const page = accountingSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/accounting-reporting/audit-support-close-acceleration";
...
export default function AuditSupportCloseAccelerationPage() {
  return (
    <>
      <Hero
