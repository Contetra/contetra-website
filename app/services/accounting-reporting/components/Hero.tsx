...
import { AccountingMotif } from "@/app/services/accounting-reporting/components/AccountingMotif";
...
export function Hero() {
  const { hero } = accountingReportingService;
