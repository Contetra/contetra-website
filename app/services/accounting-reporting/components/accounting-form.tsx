...
export const AccountingForm = ({ trigger }: AccountingFormProps) => {
  ...
  const [submitForm, { data: taigasData, isError, isSuccess, error, isLoading }] =
  ...
  }, [isSuccess, taigasData, isError, error, submitForm, form, router]);
  ...
  return (
    <Sheet open={sheetOpen} onOpenChange={setSheetOpen}>
      <SheetTrigger asChild>
        {trigger ?? (
          <Button type="button">Download Financial Reporting Pack</Button>
        )}
      </SheetTrigger>
      ...
      >
        <SheetHeader className="sr-only">
          <SheetTitle>Download the Financial Reporting Pack</SheetTitle>
          <SheetDescription>
            Complete the form to receive the financial reporting resources.
          </SheetDescription>
        </SheetHeader>
