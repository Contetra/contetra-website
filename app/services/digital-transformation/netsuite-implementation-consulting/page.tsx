...
const SLUG = "netsuite-implementation-consulting";

const page = erpSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/digital-transformation/netsuite-implementation-consulting";
...
export default function NetsuiteImplementationConsultingPage() {
  return (
    <>
      <script
