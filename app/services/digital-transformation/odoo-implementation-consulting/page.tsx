...
const SLUG = "odoo-implementation-consulting";

const page = erpSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/digital-transformation/odoo-implementation-consulting";
...
export default function OdooImplementationConsultingPage() {
  return (
    <>
      <script
