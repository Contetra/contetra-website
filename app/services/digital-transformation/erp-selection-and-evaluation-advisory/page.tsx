...
const SLUG = "erp-selection-evaluation";

const page = erpSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/digital-transformation/erp-selection-evaluation";
...
export default function ErpSelectionAndEvaluationAdvisoryPage() {
  return (
    <>
      <script
