...
const SLUG = "microsoft-dynamics-365-consulting";

const page = erpSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/digital-transformation/microsoft-dynamics-365-consulting";
...
export default function MicrosoftDynamics365ConsultingPage() {
  return (
    <>
      <script
