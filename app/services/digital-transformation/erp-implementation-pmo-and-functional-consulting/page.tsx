...
const SLUG = "erp-implementation-pmo";

const page = erpSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/digital-transformation/erp-implementation-pmo";
...
export default function ErpImplementationPmoAndFunctionalConsultingPage() {
  return (
    <>
      <script
