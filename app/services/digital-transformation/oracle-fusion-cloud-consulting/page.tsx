...
const SLUG = "oracle-fusion-cloud-consulting";

const page = erpSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/digital-transformation/oracle-fusion-cloud-consulting";
...
export default function OracleFusionCloudConsultingPage() {
  return (
    <>
      <script
