...
const SLUG = "automation-opportunity-assessment";

const page = agenticAiSubPages.find((p) => p.slug === SLUG)!;
const pagePath = "/services/agentic-ai-and-process-automation/automation-opportunity-assessment";
...
export default function AutomationOpportunityAssessmentPage() {
  return (
    <>
      <script
