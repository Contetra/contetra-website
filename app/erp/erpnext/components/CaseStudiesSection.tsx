  ...
  return (
    <section className="py-20 text-[#1a1640] dark:bg-[#0A0A0A]">
      <div className="mx-auto max-w-[1200px] px-6">
        <h2 className="mb-14 text-center text-3xl font-semibold leading-tight text-[#1a1640] dark:text-white md:text-[2.6rem]">Case Studies, Why Contetra and FAQs</h2>
        <SectionHeading title="ERPNext Case Study Snapshots" level="h3" />
