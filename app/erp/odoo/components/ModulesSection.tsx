      ...
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="space-y-6 text-center mb-10">
          ...
          <h2 className="text-3xl font-semibold tracking-tight dark:text-white md:text-4xl">
            Odoo ERP Modules and Industries We Support
          </h2>
        ...
        <p className="mx-auto mt-8 max-w-3xl text-center text-base leading-8 text-slate-600 dark:text-[#E5E7EB]">
          An experienced Odoo functional consultant can help determine which modules should be configured first, which workflows need standardisation and where customisation is genuinely necessary.
        </p>
      </div>
    </section>
  );
