...
const sbfmsFormSchema = z.object({
  ...
  full_name: z.string().trim().min(2, { message: "Please enter your full name." }),
  ...
  designation: z.string().trim().min(2, { message: "Please enter your designation." }),
...
export function SbfmsBottomSection() {
  ...
  return (
    <section className="w-full" aria-label="Schedule a free review call">
      <div
        className={cn(
          "relative mx-auto w-full max-w-[1920px] ",
          "flex min-h-[200px] items-center justify-center px-4 py-12",
          "xl:block xl:min-h-[max(260px,min(48vw,560px))] xl:px-0 xl:py-8",
        )}
      >
        <div
          className="pointer-events-none absolute inset-0 hidden bg-contain bg-center bg-no-repeat xl:block"
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[15px] font-semibold leading-snug">
                          Q1. What is your primary reason for considering Finance
                          Mentoring?
                        </FormLabel>
                        <FormControl>
                          <QuestionRadioGroup
                ...
                {step === 1 && (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[15px] font-semibold leading-snug">
                          Q2. Where do you envision your business in the next few
                          years?
                        </FormLabel>
                        <FormControl>
                          <QuestionRadioGroup
                ...
                {step === 5 && (
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel className="text-[15px] font-semibold leading-snug">
                          Q6. How would you describe your current financial planning
                          process?
                        </FormLabel>
                        <FormControl>
                          <QuestionRadioGroup
