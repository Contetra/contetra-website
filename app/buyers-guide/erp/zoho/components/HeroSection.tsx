      ...
      <div className="relative mx-auto max-w-[1200px] px-6 text-center">
        ...
        <ScrollReveal y={22} delay={0.1}>
          <h1 className="mx-auto mb-6 max-w-4xl text-[clamp(2.1rem,4.5vw,3.6rem)] font-bold leading-tight text-white">
            Zoho ERP Implementation &amp; Consulting Partners: A Buyer&apos;s
        ...
        <ScrollReveal y={22} delay={0.3}>
          <p className="mx-auto mb-10 max-w-4xl text-base leading-7 text-white/80 dark:text-[#D1D5DB]">
            Whether you prefer Zoho One or want to build an ecosystem using
            Zoho Books, Inventory, CRM, and other apps, this guide helps
            founders, finance leaders, COOs, operations managers, and
            business owners evaluate implementation and consulting
