...
export function CuTopSection() {
  return (
    <section className="w-full dark:bg-[#0A0A0A]">
      <div className="w-full bg-[#122a66] px-[12px] pb-[96px] pt-14 dark:bg-[#0A0A0A] sm:px-5 sm:pb-[110px] sm:pt-16 md:px-8 md:pb-[120px] md:pt-20 xl:px-14 2xl:px-[80px]">
      ...
      <div className="w-full px-[12px] pb-8 dark:bg-[#0A0A0A] sm:px-5 sm:pb-10 md:px-8 md:pb-12 xl:px-14 2xl:px-[80px] mt-5">
        <div className="mx-auto -mt-[76px] flex w-full max-w-[1100px] flex-col items-center">
          <div className="grid w-full max-w-[900px] gap-5 sm:grid-cols-3">
            <article className="min-h-[190px] rounded-[10px] bg-[#fff] px-5 py-6 text-center shadow-[0_2px_10px_rgba(0,0,0,0.12)] dark:border dark:border-[#1F2937] dark:bg-[#111827] dark:shadow-[0_12px_36px_rgba(0,0,0,0.28)]">
              ...
              <p className="mt-6 text-[25px] leading-[1.35] text-[#10213e] dark:text-[#E5E7EB] sm:text-[18px] md:text-[20px]">
                +91 98338 18857
              </p>
            </article>
            ...
            <article className="min-h-[190px] rounded-[10px] bg-[#fff] px-5 py-6 text-center shadow-[0_2px_10px_rgba(0,0,0,0.12)] dark:border dark:border-[#1F2937] dark:bg-[#111827] dark:shadow-[0_12px_36px_rgba(0,0,0,0.28)]">
              ...
              <p className="mt-6 text-[17px] leading-[1.45] text-[#10213e] dark:text-[#E5E7EB] sm:text-[15px] md:text-[20px]">
            ...
            <article className="min-h-[190px] rounded-[10px] bg-[#fff] px-5 py-6 text-center shadow-[0_2px_10px_rgba(0,0,0,0.12)] dark:border dark:border-[#1F2937] dark:bg-[#111827] dark:shadow-[0_12px_36px_rgba(0,0,0,0.28)]">
              ...
              <p className="mt-6 text-[20px] leading-[1.35] text-[#10213e] dark:text-[#E5E7EB] sm:text-[17px] md:text-[20px]">
                growth@contetra.com
              </p>
            </article>
          </div>

          <div className="mt-6 w-full max-w-[1200px] overflow-hidden rounded-[4px] border border-[#d8d8d8] bg-white dark:border-[#1F2937] dark:bg-[#111827]">
