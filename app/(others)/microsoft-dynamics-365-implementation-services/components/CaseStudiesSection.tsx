    ...
    <section className="bg-[#f8f9fb] py-20 text-[#1a2d45]">
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="mx-auto mb-12 max-w-3xl text-center">
          <div className="mb-3 text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-[#0e7c7b]">Case Study Snapshots</div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {caseStudies.map((cs) => (
            <div key={cs.title} className="overflow-hidden rounded-[14px] border border-[#e5e8ef] bg-white shadow-[0_4px_20px_rgba(26,45,69,0.08)] transition duration-200 hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(26,45,69,0.14)]">
              ...
              <div className="space-y-4 p-6">
                <div className="space-y-3">
                  <div className="flex gap-3 text-sm">
                    <div className="w-[74px] flex-shrink-0 text-[0.7rem] font-bold uppercase tracking-[0.08em] text-[#0e7c7b]">Need</div>
                    <div className="text-sm leading-6 text-[#4d5b6e]">{cs.challenge}</div>
                  </div>
                  <div className="flex gap-3 text-sm">
                    <div className="w-[74px] flex-shrink-0 text-[0.7rem] font-bold uppercase tracking-[0.08em] text-[#0e7c7b]">Support</div>
                    <div className="text-sm leading-6 text-[#4d5b6e]">{cs.solution}</div>
                  </div>
                </div>
                <div className="mt-4 flex gap-3 border-t border-[#e5e8ef] pt-4">
                  <div className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-[#0e7c7b]/12 text-sm font-bold text-[#0e7c7b]">OK</div>
