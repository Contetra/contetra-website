    ...
    <section className="bg-[#1a1640] py-20 text-white">
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="grid gap-10 md:grid-cols-2 md:items-start">
          <div>
            <div className="mb-3 text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-[#50a085]">Industry Fit</div>
          ...
          <div className="overflow-hidden rounded-[14px] border border-white/10 bg-white/5">
            <div className="grid grid-cols-[0.8fr_1.4fr] border-b border-white/10 bg-[#50a085]/25">
