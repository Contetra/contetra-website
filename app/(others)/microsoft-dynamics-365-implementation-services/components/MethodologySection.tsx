    ...
    <section className="py-20">
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="mb-12 max-w-3xl text-center mx-auto">
          <div className="mb-3 text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-[#0e7c7b]">Our Methodology</div>
        ...
        <div className="relative overflow-hidden rounded-[16px] bg-[#0d1b2a] px-6 py-16 sm:px-10 sm:py-20">
          ...
          <div className="grid gap-8 xl:grid-cols-5 lg:grid-cols-3 md:grid-cols-2">
            {steps.map((step, i) => (
              <div key={i} className="relative z-10 flex flex-col items-center text-center">
                <div className="mb-5 flex h-[4.5rem] w-[4.5rem] items-center justify-center rounded-full border-4 border-[#0e7c7b] bg-[#0d1b2a] text-lg font-serif font-bold text-[#14a8a7] transition duration-200 hover:bg-[#0e7c7b] hover:text-white">
                  {step.num}
                </div>
