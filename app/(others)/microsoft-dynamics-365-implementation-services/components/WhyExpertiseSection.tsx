    ...
    <section className="bg-[#1a1640] py-20 text-white">
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="mx-auto mb-12 max-w-3xl text-center">
          <div className="mb-3 text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-[#50a085]">Why Contetra</div>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {whyItems.map((item, i) => (
            <div key={item.title} className="rounded-[12px] border border-white/10 bg-white/5 p-7 transition duration-200 hover:-translate-y-1 hover:border-[#50a085]/30 hover:bg-[#50a085]/10">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-[10px] bg-[#50a085]/20  text-xl font-bold text-[#50a085]">{String(i + 1).padStart(2, '0')}</div>
