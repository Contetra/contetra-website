...
export default function HeroSection() {
  return (
    <section className="relative overflow-hidden bg-[#1a1640] py-24 md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-6">
        <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm text-white/70">
          ...
          <span className="opacity-50">/</span>
          <span className="text-[#50a085]">Microsoft Dynamics 365</span>
        </nav>

        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            <div className="mb-6 flex items-center gap-3">
              <span className="inline-block h-[2px] w-8 bg-[#50a085]" />
              <span className="text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-[#50a085]">Microsoft Dynamics 365 Implementation Services</span>
            </div>
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="/contact-us" className="inline-flex items-center justify-center rounded-sm border border-[#221971] bg-[#221971] px-8 py-3 text-sm font-semibold text-white transition duration-200 hover:bg-[#181253] hover:shadow-[0_8px_24px_rgba(34,25,113,0.28)]">
                Schedule an ERP Scope & ROI Audit
              </Link>
              <Link href="/erp-implementation-solutions" className="inline-flex items-center justify-center rounded-sm border border-[#50a085] bg-white/5 px-8 py-3 text-sm font-semibold text-white transition duration-200 hover:bg-[#50a085]/15">
          ...
          <div className="relative">
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="rounded-[12px] border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition duration-200 hover:-translate-y-1 hover:border-[#50a085]/40">
                <div className="mb-1 text-[2.2rem]  font-bold leading-none text-[#50a085]">Scope</div>
                <div className="text-sm font-medium text-white/70">ERP requirements, risks and ROI clarity</div>
              </div>
              <div className="rounded-[12px] border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition duration-200 hover:-translate-y-1 hover:border-[#50a085]/40">
                <div className="mb-1 text-[2.2rem]  font-bold leading-none text-[#50a085]">BRD</div>
                <div className="text-sm font-medium text-white/70">Functional requirements before configuration</div>
              </div>
              <div className="sm:col-span-2 rounded-[12px] border border-[#50a085]/25 bg-[#50a085]/12 p-6 backdrop-blur-sm transition duration-200 hover:-translate-y-1">
                <div className="mb-1 text-[2.2rem]  font-bold leading-none text-[#50a085]">10+</div>
                <div className="text-sm font-medium text-white/70">Years of finance transformation and ERP advisory experience</div>
              </div>
              <div className="rounded-[12px] border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition duration-200 hover:-translate-y-1 hover:border-[#50a085]/40">
                <div className="mb-1 text-[2.2rem]  font-bold leading-none text-[#50a085]">MIS</div>
                <div className="text-sm font-medium text-white/70">Power BI and management reporting design</div>
              </div>
              <div className="rounded-[12px] border border-white/10 bg-white/5 p-6 backdrop-blur-sm transition duration-200 hover:-translate-y-1 hover:border-[#50a085]/40">
                <div className="mb-1 text-[2.2rem]  font-bold leading-none text-[#50a085]">UAT</div>
