    ...
    <section className="bg-gradient-to-br from-[#1a1640] via-[#221971] to-[#1a1640] py-24 text-white">
      <div className="mx-auto max-w-[720px] px-6 text-center">
        ...
        <div className="mx-auto flex flex-wrap justify-center gap-4">
          <Link href="/contact" className="inline-flex items-center justify-center rounded-sm bg-[#50a085] px-8 py-3 text-sm font-semibold text-white transition hover:bg-[#459678]">
