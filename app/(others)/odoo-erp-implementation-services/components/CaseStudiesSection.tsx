        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {caseStudies.map((caseStudy, i) => (
            <div key={i} className="overflow-hidden rounded-[14px] border border-slate-200 bg-white shadow-[0_4px_20px_rgba(15,23,42,0.08)] transition hover:-translate-y-1 hover:shadow-[0_16px_40px_rgba(15,23,42,0.14)]">
              <div className="space-y-2 bg-gradient-to-br from-[#1a2d45] to-[#0e7c7b] p-6 text-white">
              ...
              <div className="space-y-4 p-6">
                <div className="space-y-3">
                  <div className="flex gap-3 text-sm">
                    <div className="w-[70px] flex-shrink-0 font-bold uppercase tracking-[0.08em] text-[#0e7c7b]">Challenge</div>
                    <div className="text-sm leading-7 text-slate-600">{caseStudy.challenge}</div>
                  </div>
                  <div className="flex gap-3 text-sm">
                    <div className="w-[70px] flex-shrink-0 font-bold uppercase tracking-[0.08em] text-[#0e7c7b]">Solution</div>
                ...
                <div className="mt-4 flex gap-3 border-t border-slate-200 pt-4">
                  <div className="flex h-6 w-6 items-center justify-center rounded-full bg-[#0e7c7b]/10 text-[#0e7c7b] text-sm font-bold">✓</div>
