...
const heroStats = [
  { value: "Scope", label: "ERP requirements, risks and ROI clarity" },
  { value: "FRD", label: "Functional documentation before configuration" },
  { value: "10+", label: "Years of finance transformation and ERP advisory" },
  { value: "UAT", label: "Testing, issue tracking and go-live readiness" },
  { value: "MIS", label: "CFO dashboards and management reporting design" },
];
    ...
    <section className="relative overflow-hidden bg-[#1a1640] py-24 dark:bg-[#0A0A0A] md:py-28">
      ...
      <div className="relative z-10 mx-auto max-w-[1200px] px-6">
        <nav className="mb-8 flex flex-wrap items-center gap-2 text-sm text-white/70">
          ...
          <span className="opacity-50">/</span>
          <span className="text-[#50a085] dark:text-[#86efac]">Oracle ERP</span>
        </nav>
        ...
        <div className="grid gap-10 md:grid-cols-2 md:items-center">
          <div>
            <div className="mb-6 flex items-center gap-3">
              ...
              <span className="text-[0.7rem] font-semibold uppercase tracking-[0.18em] text-[#50a085] dark:text-[#86efac]">Oracle ERP Implementation Services</span>
            </div>
            ...
            <p className="mb-5 max-w-[560px] text-[1.18rem] leading-[1.7] text-white/80 dark:text-[#E5E7EB]">
              Implement Oracle ERP around finance control, operational visibility and scalable decision-making.
            </p>
